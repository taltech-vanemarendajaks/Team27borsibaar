...
class OrganizationServiceTest {
  ...
  void create_SetsCreatedAtAndMaps() {
    ...
    when(organizationMapper.toResponse(saved))
        .thenReturn(
  ...
  void getById_NotFound_Throws() {
    ...
    ResponseStatusException ex =
        assertThrows(ResponseStatusException.class, () -> organizationService.getById(99L));
  ...
  void getAll_ReturnsMappedList() {
    ...
    when(organizationMapper.toResponse(o))
        .thenReturn(
            new OrganizationResponseDto(
                1L,
                "A",
