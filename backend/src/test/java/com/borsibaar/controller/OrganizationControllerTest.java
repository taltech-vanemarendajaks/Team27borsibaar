...
class OrganizationControllerTest {
  ...
  void create_ReturnsCreated() throws Exception {
    OrganizationRequestDto req =
        new OrganizationRequestDto("Org", BigDecimal.valueOf(0.5), BigDecimal.valueOf(0.5));
    OrganizationResponseDto resp =
  ...
  void get_ReturnsDto() throws Exception {
    ...
    mockMvc
        .perform(get("/api/organizations/2"))
  ...
  void update_ReturnsUpdatedDto() throws Exception {
    OrganizationRequestDto req =
        new OrganizationRequestDto(
            "Updated Org", BigDecimal.valueOf(1.0), BigDecimal.valueOf(0.25));
    OrganizationResponseDto resp =
        new OrganizationResponseDto(
            5L,
            "Updated Org",
