...
class ProductControllerTest {
  ...
  void testCreateProduct_Success() throws Exception {
    ...
    when(productService.create(any(ProductRequestDto.class), eq(1L))).thenReturn(response);
    ...
    when(productService.create(any(ProductRequestDto.class), eq(1L)))
        .thenThrow(
            new ResponseStatusException(
                HttpStatus.CONFLICT, "Product with name 'Duplicate Product' already exists"));
  ...
  void testCreateProduct_WithInvalidCategory_ReturnsBadRequest() throws Exception {
    ...
    when(productService.create(any(ProductRequestDto.class), eq(1L)))
        .thenThrow(new ResponseStatusException(HttpStatus.BAD_REQUEST, "Category not found: 999"));
  ...
  void testGetProduct_NotFound() throws Exception {
    ...
    when(productService.getById(999L))
        .thenThrow(new ResponseStatusException(HttpStatus.NOT_FOUND, "Product not found: 999"));
  ...
  void testDeleteProduct_NotFound() throws Exception {
    ...
    org.mockito.Mockito.doThrow(
            new ResponseStatusException(HttpStatus.NOT_FOUND, "Product not found: 999"))
        .when(productService)
        .delete(999L);
