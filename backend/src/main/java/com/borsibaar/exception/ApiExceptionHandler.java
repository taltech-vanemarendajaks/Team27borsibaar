...
public class ApiExceptionHandler {
  ...
  public ProblemDetail handleNotFound(NotFoundException exception, HttpServletRequest request) {
    return buildProblemDetail(
        HttpStatus.NOT_FOUND, "Not Found", exception.getMessage(), request.getRequestURI());
  }
  ...
  public ProblemDetail handleDuplicate(
    ...
    return buildProblemDetail(
        HttpStatus.CONFLICT, "Duplicate resource", exception.getMessage(), request.getRequestURI());
  }

  @ExceptionHandler(BadRequestException.class)
  public ProblemDetail handleBadRequest(BadRequestException exception, HttpServletRequest request) {
    return buildProblemDetail(
        HttpStatus.BAD_REQUEST, "Bad request", exception.getMessage(), request.getRequestURI());
  }
  ...
  public ProblemDetail handleValidation(
    ...
    ProblemDetail problemDetail =
        buildProblemDetail(
            HttpStatus.BAD_REQUEST, "Validation failed", detail, request.getRequestURI());
  ...
  public ProblemDetail handleConstraintViolation(
    ...
    return buildProblemDetail(
        HttpStatus.BAD_REQUEST, "Constraint violation", detail, request.getRequestURI());
  }
