...
public class SecurityUtils {
   ...
   * @throws ResponseStatusException if user is not authenticated or not a User instance
   */
  ...
  /**
   * Checks if the currently authenticated user has the ADMIN role. Gets the user from the
   * SecurityContext.
   *
