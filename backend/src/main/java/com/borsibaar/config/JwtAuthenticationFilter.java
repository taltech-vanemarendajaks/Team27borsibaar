...
/**
 * JWT Authentication Filter that intercepts every request and validates JWT tokens from cookies. If
 * valid, sets the authentication in the SecurityContext for downstream authorization.
 */
@Component
